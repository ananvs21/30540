    ...
    public class DriveLocalizer implements Localizer {
        ...
        public PoseVelocity2d update() {
            ...
            if (!initialized) {
                ...
                lastFrontLeftPos = leftFrontPosVel.position;
                lastBackLeftPos = leftBackPosVel.position;
                lastBackRightPos = rightBackPosVel.position;
                lastFrontRightPos = rightFrontPosVel.position;
            ...
            Twist2dDual<Time> twist = kinematics.forward(new MecanumKinematics.WheelIncrements<>(
                    new DualNum<Time>(new double[]{
                            (leftFrontPosVel.position - lastFrontLeftPos),
                            leftFrontPosVel.velocity,
                    }).times(PARAMS.inPerTick),
                    new DualNum<Time>(new double[]{
                            (leftBackPosVel.position - lastBackLeftPos),
                            leftBackPosVel.velocity,
                    }).times(PARAMS.inPerTick),
                    new DualNum<Time>(new double[]{
                            (rightBackPosVel.position - lastBackRightPos),
                            rightBackPosVel.velocity,
                    }).times(PARAMS.inPerTick),
                    new DualNum<Time>(new double[]{
                            (rightFrontPosVel.position - lastFrontRightPos),
